...
#pragma config(Sensor, I2C_3,  driveEncoder,   sensorQuadEncoderOnI2CPort,    , AutoAssign )
...
#pragma config(Motor,  port6,           driveSplitRight, tmotorVex393_MC29, openLoop, driveRight, encoderPort, I2C_3)
