...
#pragma config(Sensor, dgtl1,  leftMogoDetector, sensorTouch)
#pragma config(Sensor, dgtl2,  rightMogoDetector, sensorTouch)
#pragma config(Sensor, dgtl3,  leftMogoIndicator, sensorLEDtoVCC)
#pragma config(Sensor, dgtl4,  rightMogoIndicator, sensorLEDtoVCC)
