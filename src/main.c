...
#pragma config(Motor,  port8,           driveRightFront, tmotorVex393_MC29, openLoop, reversed, driveLeft)
#pragma config(Motor,  port9,           driveLeftRear, tmotorVex393_MC29, openLoop, reversed, driveRight)
